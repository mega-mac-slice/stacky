...
class TestExtraStackOnly(TestCase):
    ...
    def test_status_success(self):
        os.chdir(target)
        result = subprocess.check_output('stacky status', shell=True, stderr=subprocess.STDOUT)
...
class TestExtraStackAndOneExtra(TestCase):
    ...
    def test_status_success(self):
        os.chdir(target)
        result = subprocess.check_output('stacky status redis', shell=True, stderr=subprocess.STDOUT)
...
class TestExtraStackAndMultiExtra(TestCase):
    ...
    def test_status_success(self):
        os.chdir(target)
        result = subprocess.check_output('stacky status redis elasticsearch', shell=True, stderr=subprocess.STDOUT)
